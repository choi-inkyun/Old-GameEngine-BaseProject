...
#ifndef __ENGINE_D3DINPUT_H__
#define __ENGINE_D3DINPUT_H__

// to prevent from getting a warning.
#define DIRECTINPUT_VERSION		0x0800

#include <dinput.h>

// Enumerated list of input device types
enum InputDevices
{
	NONE = 0,
	KEYBOARD,
...
#define KEY_SEMUCOLON		DIK_SEMICOLON
...
class __declspec(dllexport) cInputDevice
{
private:
	cInput				*m_Input;
...
public:
	...
	BOOL GetLock( BYTE Num );
	BOOL SetLock( BYTE Num, BOOL State = TRUE );
	...
	BOOL SetKeyState( BYTE Num, BOOL State );
	...
	BOOL SetButtonState( BYTE Num, BOOL State );
